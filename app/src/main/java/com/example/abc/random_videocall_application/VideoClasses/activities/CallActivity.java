...
import com.example.abc.random_videocall_application.VideoClasses.fragments.ConversationFragmentCallbackListener;
import com.example.abc.random_videocall_application.VideoClasses.fragments.IncomeCallFragment;
import com.example.abc.random_videocall_application.VideoClasses.fragments.IncomeCallFragmentCallbackListener;
import com.example.abc.random_videocall_application.VideoClasses.fragments.OnCallEventsController;
import com.example.abc.random_videocall_application.VideoClasses.fragments.ScreenShareFragment;
import com.example.abc.random_videocall_application.VideoClasses.fragments.VideoConversationFragment;
import com.example.abc.random_videocall_application.VideoClasses.util.NetworkConnectionChecker;
import com.example.abc.random_videocall_application.VideoClasses.utils.Consts;
import com.example.abc.random_videocall_application.VideoClasses.utils.FragmentExecuotr;
import com.example.abc.random_videocall_application.VideoClasses.utils.PermissionsChecker;
import com.example.abc.random_videocall_application.VideoClasses.utils.QBEntityCallbackImpl;
import com.example.abc.random_videocall_application.VideoClasses.utils.RingtonePlayer;
import com.example.abc.random_videocall_application.VideoClasses.utils.SettingsUtil;
...
//            we have already currentSession == null, so it's no reason to do further initialization
    ...
    @Override
    public void addTCClientConnectionCallback(VideoConversationFragment clientConnectionCallbacks) {
        if (currentSession != null) {
            currentSession.addSessionCallbacksListener((QBRTCSessionStateCallback) clientConnectionCallbacks);
        }
    }

    @Override
    public void addRTCSessionEventsCallback(VideoConversationFragment eventsCallback) {
        QBRTCClient.getInstance(this).addSessionCallbacksListener((QBRTCSessionEventsCallback) eventsCallback);
    }
    ...
    @Override
    public void removeRTCClientConnectionCallback(VideoConversationFragment clientConnectionCallbacks) {
        if (currentSession != null) {
            currentSession.removeSessionCallbacksListener((QBRTCSessionStateCallback) clientConnectionCallbacks);
        }
    }

    @Override
    public void removeRTCSessionEventsCallback(VideoConversationFragment eventsCallback) {
        QBRTCClient.getInstance(this).removeSessionsCallbacksListener((QBRTCSessionEventsCallback) eventsCallback);
    }

    @Override
    public void addCurrentCallStateCallback(BaseConversationFragment currentCallStateCallback) {
        currentCallStateCallbackList.add(currentCallStateCallback);
    }

    @Override
    public void removeCurrentCallStateCallback(BaseConversationFragment currentCallStateCallback) {
        currentCallStateCallbackList.remove(currentCallStateCallback);
    }

    @Override
    public void addOnChangeAudioDeviceCallback(AudioConversationFragment onChangeDynamicCallback) {
        this.onChangeAudioDeviceCallback = onChangeDynamicCallback;
        notifyAboutCurrentAudioDevice();
    }

    @Override
    public void removeOnChangeAudioDeviceCallback(AudioConversationFragment onChangeDynamicCallback) {
